...
/* -------------------------------
   1.0 CONTROLLER - App
------------------------------- */
myApp.controller('appController', ['$rootScope', '$scope', function($rootScope, $scope) {
    ...
    $scope.$on('$stateChangeStart', function() {
        ...
        $rootScope.setting.layout.pageTopMenu = false;              //上菜单栏
        ...
        $rootScope.setting.layout.pageLanguageBar = false;          //头部的语言设置
...
/* -------------------------------
   3.0 CONTROLLER - Right Sidebar
------------------------------- */
myApp.controller('rightSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   5.0 CONTROLLER - Top Menu
------------------------------- */
myApp.controller('topMenuController', function($scope, $rootScope, $state) {
    setTimeout(function() {
        App.initTopMenu();
    }, 0);
});
...
/* -------------------------------
   7.0 CONTROLLER - Theme Panel
------------------------------- */
myApp.controller('themePanelController', function($scope, $rootScope, $state) {
    App.initThemePanel();
});
...
/* -------------------------------
   8.0 CONTROLLER - Dashboard v1
------------------------------- */
myApp.controller('dashboardController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        ...
        /* Gritter Notification jquery.gritter插件 消息通知栏
        ------------------------- */
        // setTimeout(function() {
        //     $.gritter.add({
...
/* -------------------------------
   9.0 CONTROLLER - Dashboard v2
------------------------------- */
myApp.controller('dashboardV2Controller', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        /* Line Chart
        ------------------------- */
        var green = '#0D888B';
        ...
        $('#visitors-map').vectorMap({
            ...
            // 设置地图区域的样式。每个区域或标记具有四种状态：（initial默认状态），hover（当鼠标光标selected在区域或标记上时），selectedHover（当选择区域或标记时），（当鼠标光标在区域或标记上并且同时选择）。可以为每个状态设置样式。该参数的默认值为：
            regionStyle: {
                initial: {
                    fill: 'rgb(97,109,125)',    //地图领土的颜色
                    "fill-opacity": 1,
                    stroke: 'none',
                    "stroke-width": 0.4,
                    "stroke-opacity": 1
...
/* -------------------------------
   10.0 CONTROLLER - Email Inbox v1
------------------------------- */
myApp.controller('emailInboxController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   11.0 CONTROLLER - Email Inbox v2
------------------------------- */
myApp.controller('emailInboxV2Controller', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageContentFullWidth = true;
...
/* -------------------------------
   12.0 CONTROLLER - Email Compose
------------------------------- */
myApp.controller('emailComposeController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageContentFullWidth = true;
...
/* -------------------------------
   13.0 CONTROLLER - Email Detail
------------------------------- */
myApp.controller('emailDetailController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageContentFullWidth = true;
});
...
/* -------------------------------
   14.0 CONTROLLER - UI Modal & Notifications
------------------------------- */
myApp.controller('uiModalNotificationController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        /* Gritter Notification
        ------------------------- */
...
/* -------------------------------
   15.0 CONTROLLER - UI Tree
------------------------------- */
myApp.controller('uiTreeController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
...
/* -------------------------------
   16.0 CONTROLLER - UI Language Bar
------------------------------- */
myApp.controller('uiLanguageBarIconController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   17.0 CONTROLLER - Form Plugins
------------------------------- */
myApp.controller('formPluginsController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        /* Datepicker
        ------------------------- */
...
/* -------------------------------
   18.0 CONTROLLER - Form Slider + Switcher
------------------------------- */
myApp.controller('formSliderSwitcherController', function($scope, $rootScope, $state) {   
    angular.element(document).ready(function () {
        var green = '#00acac',
        red = '#ff5b57',
        blue = '#348fe2',
...
/* -------------------------------
   19.0 CONTROLLER - Form Validation
------------------------------- */
myApp.controller('formValidationController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   20.0 CONTROLLER - Table Manage Default
------------------------------- */
myApp.controller('tableManageDefaultController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
...
/* -------------------------------
   21.0 CONTROLLER - Table Manage Autofill
------------------------------- */
myApp.controller('tableManageAutofillController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                autoFill: true,
...
/* -------------------------------
   22.0 CONTROLLER - Table Manage Buttons
------------------------------- */
myApp.controller('tableManageButtonsController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                dom: 'Bfrtip',
...
/* -------------------------------
   23.0 CONTROLLER - Table Manage ColReorder
------------------------------- */
myApp.controller('tableManageColReorderController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                colReorder: true,
...
/* -------------------------------
   24.0 CONTROLLER - Table Manage Fixed Columns
------------------------------- */
myApp.controller('tableManageFixedColumnsController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                scrollY:        300,
...
/* -------------------------------
   25.0 CONTROLLER - Table Manage Fixed Header
------------------------------- */
myApp.controller('tableManageFixedHeaderController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                lengthMenu: [20, 40, 60],
...
/* -------------------------------
   26.0 CONTROLLER - Table Manage KeyTable
------------------------------- */
myApp.controller('tableManageKeyTableController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                scrollY: 300,
...
/* -------------------------------
   27.0 CONTROLLER - Table Manage Responsive
------------------------------- */
myApp.controller('tableManageResponsiveController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                // responsive: true;
            ...
            $("div.toolbar").html(' <div class="form-group"> <label class="col-md-4 control-label">Auto Close Datepicker</label> <div class="col-md-8"> <input type="text" class="form-control" id="datepicker-autoClose" placeholder="Auto Close Datepicker" /> </div> </div>');
        }
    });
    $scope.arr = [
        {renderingEngine:'Trident1' , browser:"Konqureror 3.3" , platform:"KDE 3.3" , engineVersion:"3.3" , css:"A"},
...
/* -------------------------------
   28.0 CONTROLLER - Table Manage RowReorder
------------------------------- */
myApp.controller('tableManageRowReorderController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                responsive: true,
...
/* -------------------------------
   29.0 CONTROLLER - Table Manage Scroller
------------------------------- */
myApp.controller('tableManageScrollerController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
...
/* -------------------------------
   30.0 CONTROLLER - Table Manage Select
------------------------------- */
myApp.controller('tableManageSelectController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                select: true,
...
/* -------------------------------
   31.0 CONTROLLER - Table Manage Extension Combination
------------------------------- */
myApp.controller('tableManageCombineController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                dom: 'lBfrtip',
...
/* -------------------------------
   32.0 CONTROLLER - Flot Chart
------------------------------- */
myApp.controller('chartFlotController', function($scope, $rootScope, $state) {
    /* Basic Chart
    ------------------------- */
    var d1 = [], d2 = [], d3 = [];
...
/* -------------------------------
   33.0 CONTROLLER - Morris Chart
------------------------------- */
myApp.controller('chartMorrisController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        /* Morris Line Chart
        ------------------------- */
        var tax_data = [
...
/* -------------------------------
   34.0 CONTROLLER - Chart JS
------------------------------- */
myApp.controller('chartJsController', function($scope, $rootScope, $state) {
    // white
    ...
    /* ChartJS Radar Chart
    ------------------------- */
    $scope.radarChartLabels = ['Eating', 'Drinking', 'Sleeping', 'Designing', 'Coding', 'Cycling', 'Running'];
    $scope.radarChartOverride = [{
        label: 'Dataset 1',
        borderWidth: 2,
        borderColor: strokePurple,
        pointBackgroundColor: strokePurple,
    ...
    $scope.radarChartData = [[28,48,40,19,96,27,100],[65,59,90,81,56,55,40]];
    
    
    /* ChartJS Polar Area Chart
    ------------------------- */
    $scope.polarAreaChartLabels = ['Purple', 'Blue', 'Green', 'Grey', 'Black'];
    $scope.polarAreaChartOverride = [{
    ...
    $scope.polarAreaChartData = [[300, 160, 100, 200, 120]];
    
    
    /* ChartJS Pie Chart
    ------------------------- */
    $scope.pieChartLabels = ['Purple', 'Blue', 'Green', 'Grey', 'Black'];
    $scope.pieChartOverride = [{
        backgroundColor: [fillPurple, fillBlue, fillGreen, fillGrey, fillBlack],
        borderColor: [strokePurple, strokeBlue, strokeGreen, strokeGrey, strokeBlack],
        borderWidth: 2,
        label: 'My dataset'
    }];
    $scope.pieChartData = [[300, 50, 100, 40, 120]];
    
    
    /* ChartJS Doughnut Chart
    ------------------------- */
    $scope.doughnutChartLabels = ['Purple', 'Blue', 'Green', 'Grey', 'Black'];
    $scope.doughnutChartOverride = [{
        backgroundColor: [fillPurple, fillBlue, fillGreen, fillGrey, fillBlack],
        borderColor: [strokePurple, strokeBlue, strokeGreen, strokeGrey, strokeBlack],
        borderWidth: 2,
        label: 'My dataset'
    }];
    $scope.doughnutChartData = [[300, 50, 100, 40, 120]];
});
...
/* -------------------------------
   35.0 CONTROLLER - Chart d3
------------------------------- */
myApp.controller('chartD3Controller', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
...
/* -------------------------------
   36.0 CONTROLLER - Calendar
------------------------------- */
myApp.controller('calendarController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
...
/* -------------------------------
   37.0 CONTROLLER - Vector Map
------------------------------- */
myApp.controller('mapVectorController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageContentFullWidth = true;
...
myApp.controller('mapGoogleController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageContentFullWidth = true;
...
/* -------------------------------
   39.0 CONTROLLER - Gallery V1
------------------------------- */
myApp.controller('galleryController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
...
/* -------------------------------
   40.0 CONTROLLER - Gallery V2
------------------------------- */
myApp.controller('galleryV2Controller', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
	    $('.superbox').SuperBox();
	});
});
...
/* -------------------------------
   41.0 CONTROLLER - Page with Footer
------------------------------- */
myApp.controller('pageWithFooterController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   42.0 CONTROLLER - Page without Sidebar
------------------------------- */
myApp.controller('pageWithoutSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   43.0 CONTROLLER - Page with Right Sidebar
------------------------------- */
myApp.controller('pageWithRightSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   44.0 CONTROLLER - Page with Minified Sidebar
------------------------------- */
myApp.controller('pageWithMinifiedSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   45.0 CONTROLLER - Page with Two Sidebar
------------------------------- */
myApp.controller('pageWithTwoSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   46.0 CONTROLLER - Full Height Content
------------------------------- */
myApp.controller('pageFullHeightContentController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   47.0 CONTROLLER - Page with Wide Sidebar
------------------------------- */
myApp.controller('pageWithWideSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   48.0 CONTROLLER - Page with Light Sidebar
------------------------------- */
myApp.controller('pageWithLightSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   49.0 CONTROLLER - Page with Mega Menu
------------------------------- */
myApp.controller('pageWithMegaMenuController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   50.0 CONTROLLER - Page with Top Menu
------------------------------- */
myApp.controller('pageWithTopMenuController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   51.0 CONTROLLER - Page with Boxed Layout
------------------------------- */
myApp.controller('pageWithBoxedLayoutController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   52.0 CONTROLLER - Page with Mixed Menu
------------------------------- */
myApp.controller('pageWithMixedMenuController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageTopMenu = true;
});
...
/* -------------------------------
   53.0 CONTROLLER - Page Boxed Layout with Mixed Menu
------------------------------- */
myApp.controller('pageBoxedLayoutWithMixedMenuController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageBoxedLayout = true;
    $rootScope.setting.layout.pageTopMenu = true;
});
...
/* -------------------------------
   54.0 CONTROLLER - Page with Transparent Sidebar
------------------------------- */
myApp.controller('pageWithTransparentSidebarController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   55.0 CONTROLLER - Timeline
------------------------------- */
myApp.controller('extraTimelineController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        var mapDefault;
...
/* -------------------------------
   56.0 CONTROLLER - Coming Soon
------------------------------- */
myApp.controller('comingSoonController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   57.0 CONTROLLER - 404 Error
------------------------------- */
myApp.controller('errorController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageWithoutHeader = true;
    $rootScope.setting.layout.paceTop = true;
});
...
/* -------------------------------
   58.0 CONTROLLER - Login V1
------------------------------- */
myApp.controller('loginV1Controller', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageWithoutHeader = true;
    $rootScope.setting.layout.paceTop = true;
...
/* -------------------------------
   59.0 CONTROLLER - Login V2
------------------------------- */
myApp.controller('loginV2Controller', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageWithoutHeader = true;
    $rootScope.setting.layout.paceTop = true;
...
/* -------------------------------
   60.0 CONTROLLER - Login V3
------------------------------- */
myApp.controller('loginV3Controller', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageWithoutHeader = true;
    $rootScope.setting.layout.paceTop = true;
    $rootScope.setting.layout.pageBgWhite = true;
...
/* -------------------------------
   61.0 CONTROLLER - Register V3
------------------------------- */
myApp.controller('registerV3Controller', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageWithoutHeader = true;
    $rootScope.setting.layout.paceTop = true;
    $rootScope.setting.layout.pageBgWhite = true;
...
/* -------------------------------
   62.0 CONTROLLER - Summernote
------------------------------- */
myApp.controller('summernoteController', function($scope, $rootScope, $state) {
    var markupStr;
    angular.element(document).ready(function () {
